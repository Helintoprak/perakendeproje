...
export declare const Viewer: {
    Body: ({ children, className }: ViewerBodyProps) => import("react/jsx-runtime").JSX.Element;
    Footer: ({ children, className }: ViewerFooterProps) => import("react/jsx-runtime").JSX.Element;
