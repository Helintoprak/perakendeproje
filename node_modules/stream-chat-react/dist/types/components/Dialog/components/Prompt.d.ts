...
export declare const Prompt: {
    Body: ({ children, className }: PromptBodyProps) => import("react/jsx-runtime").JSX.Element;
    Footer: ({ children, className }: PromptFooterProps) => import("react/jsx-runtime").JSX.Element;
