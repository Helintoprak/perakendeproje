...
var Campaign = class {
  ...
  async create() {
    ...
    const body = {
      id: this.id,
      message_template: (_a = this.data) == null ? void 0 : _a.message_template,
      segment_ids: (_b = this.data) == null ? void 0 : _b.segment_ids,
      sender_id: (_c = this.data) == null ? void 0 : _c.sender_id,
      sender_mode: (_d = this.data) == null ? void 0 : _d.sender_mode,
      sender_visibility: (_e = this.data) == null ? void 0 : _e.sender_visibility,
      channel_template: (_f = this.data) == null ? void 0 : _f.channel_template,
      create_channels: (_g = this.data) == null ? void 0 : _g.create_channels,
      show_channels: (_h = this.data) == null ? void 0 : _h.show_channels,
      description: (_i = this.data) == null ? void 0 : _i.description,
      name: (_j = this.data) == null ? void 0 : _j.name,
      skip_push: (_k = this.data) == null ? void 0 : _k.skip_push,
      skip_webhook: (_l = this.data) == null ? void 0 : _l.skip_webhook,
      user_ids: (_m = this.data) == null ? void 0 : _m.user_ids
    };
...
function isOwnUser(user) {
  return (user == null ? void 0 : user.total_unread_count) !== void 0;
}
...
var localMessageToNewMessagePayload = (localMessage) => {
  ...
  return {
    ...messageFields,
    pinned_at: (_a = messageFields.pinned_at) == null ? void 0 : _a.toISOString(),
    mentioned_users: mentioned_users == null ? void 0 : mentioned_users.map((user) => user.id)
  };
};
var toUpdatedMessagePayload = (message) => {
  ...
  return {
    ...
    mentioned_users: (_a = message.mentioned_users) == null ? void 0 : _a.map(
...
var deleteUserMessages = ({
  ...
  for (let i = 0; i < messages.length; i++) {
    ...
    if (((_a = message.user) == null ? void 0 : _a.id) === user.id) {
      messages[i] = message.type === "deleted" ? message : toDeletedMessage({ message, hardDelete, deletedAt });
    }
    if (((_c = (_b = message.quoted_message) == null ? void 0 : _b.user) == null ? void 0 : _c.id) === user.id) {
...
var messagePaginationCreatedAtAround = ({
  ...
  if (!(messagePaginationOptions == null ? void 0 : messagePaginationOptions.created_at_around)) return newPagination;
  let hasPrev;
  let hasNext;
  let updateHasPrev;
  let updateHasNext;
  ...
  const wholePageHasNewerMessages = !!(firstPageMsg == null ? void 0 : firstPageMsg.created_at) && new Date(firstPageMsg.created_at) > createdAtAroundDate;
  const wholePageHasOlderMessages = !!(lastPageMsg == null ? void 0 : lastPageMsg.created_at) && new Date(lastPageMsg.created_at) < createdAtAroundDate;
  ...
  if (wholePageHasNewerMessages) {
    ...
    const [firstPageMsgIsFirstInSet, lastPageMsgIsLastInSet] = [
      (firstFilteredPageMsg == null ? void 0 : firstFilteredPageMsg.id) && firstFilteredPageMsg.id === ((_a = parentSet.messages[0]) == null ? void 0 : _a.id),
      (lastFilteredPageMsg == null ? void 0 : lastFilteredPageMsg.id) && lastFilteredPageMsg.id === ((_b = parentSet.messages.slice(-1)[0]) == null ? void 0 : _b.id)
    ];
...
var messagePaginationIdAround = ({
  ...
  const [firstPageMsgIsFirstInSet, lastPageMsgIsLastInSet] = [
    (firstFilteredPageMsg == null ? void 0 : firstFilteredPageMsg.id) === ((_a = parentSet.messages[0]) == null ? void 0 : _a.id),
    (lastFilteredPageMsg == null ? void 0 : lastFilteredPageMsg.id) === ((_b = parentSet.messages.slice(-1)[0]) == null ? void 0 : _b.id)
  ];
...
var messagePaginationLinear = ({
  ...
  const containsUnrecognizedOptionsOnly = !queriedNextMessages && !queriedPrevMessages && !(messagePaginationOptions == null ? void 0 : messagePaginationOptions.id_around) && !(messagePaginationOptions == null ? void 0 : messagePaginationOptions.created_at_around);
...
var messageSetPagination = (params) => {
  ...
  if (params.parentSet.messages.length + (params.returnedPage.length - params.filteredReturnedPage.length) < params.returnedPage.length) {
    (_a = params.logger) == null ? void 0 : _a.call(
      params,
      "error",
  ...
  if ((_b = params.messagePaginationOptions) == null ? void 0 : _b.created_at_around) {
    return messagePaginationCreatedAtAround(params);
  } else if ((_c = params.messagePaginationOptions) == null ? void 0 : _c.id_around) {
...
var isChannelPinned = (channel) => {
  ...
  return !!(member == null ? void 0 : member.pinned_at);
};
var isChannelArchived = (channel) => {
  if (!channel) return false;
  const member = channel.state.membership;
  return !!(member == null ? void 0 : member.archived_at);
};
...
var messageSetBounds = (a, b) => {
  var _a, _b, _c, _d;
  return {
    newestMessageA: new Date(((_a = a[0]) == null ? void 0 : _a.created_at) ?? 0),
    oldestMessageA: new Date(((_b = a.slice(-1)[0]) == null ? void 0 : _b.created_at) ?? 0),
    newestMessageB: new Date(((_c = b[0]) == null ? void 0 : _c.created_at) ?? 0),
    oldestMessageB: new Date(((_d = b.slice(-1)[0]) == null ? void 0 : _d.created_at) ?? 0)
  };
};
...
var ChannelState = class {
  constructor(channel) {
    ...
    this.updateUserMessages = (user) => {
      const _updateUserMessages = (messages, user2) => {
        ...
        for (let i = 0; i < messages.length; i++) {
          const m = messages[i];
          if (((_a2 = m.user) == null ? void 0 : _a2.id) === user2.id) {
    ...
    this.last_message_at = ((_a = channel == null ? void 0 : channel.state) == null ? void 0 : _a.last_message_at) != null ? new Date(channel.state.last_message_at) : null;
  }
  get messages() {
    var _a;
    return ((_a = this.messageSets.find((s) => s.isCurrent)) == null ? void 0 : _a.messages) || [];
  }
  ...
  get latestMessages() {
    var _a;
    return ((_a = this.messageSets.find((s) => s.isLatest)) == null ? void 0 : _a.messages) || [];
  }
  ...
  get messagePagination() {
    var _a;
    return ((_a = this.messageSets.find((s) => s.isCurrent)) == null ? void 0 : _a.pagination) || DEFAULT_MESSAGE_SET_PAGINATION;
  }
  ...
  addMessagesSorted(newMessages, timestampChanged = false, initializing = false, addIfDoesNotExist = true, messageSetToAddToIfDoesNotExist = "current") {
    ...
    for (let i = 0; i < messagesToAdd.length; i += 1) {
      ...
      if (isMessageFormatted) {
        ...
        if (message.user && ((_a = this._channel) == null ? void 0 : _a.cid)) {
          this._channel.getClient().state.updateUserReference(message.user, this._channel.cid);
        }
        if (initializing && message.id && this.threads[message.id] && !this._channel.getClient().preventThreadCleanup) {
          delete this.threads[message.id];
        }
        const shouldSkipLastMessageAtUpdate = ((_b = this._channel.getConfig()) == null ? void 0 : _b.skip_last_msg_update_for_system_msgs) && message.type === "system";
  ...
  addReaction(reaction, message, enforce_unique) {
    ...
    const updateData = {
      id: messageToUpdate == null ? void 0 : messageToUpdate.id,
      parent_id: messageToUpdate == null ? void 0 : messageToUpdate.parent_id,
      pinned: messageToUpdate == null ? void 0 : messageToUpdate.pinned,
      show_in_channel: messageToUpdate == null ? void 0 : messageToUpdate.show_in_channel
    };
  ...
  _removeReactionFromState(messageFromState, reaction) {
    var _a, _b, _c, _d;
    const reactionToRemove = (_a = messageFromState.own_reactions) == null ? void 0 : _a.find(
      (r) => r.type === reaction.type
    );
    if (reactionToRemove && ((_b = messageFromState.reaction_groups) == null ? void 0 : _b[reactionToRemove.type])) {
    ...
    messageFromState.own_reactions = (_c = messageFromState.own_reactions) == null ? void 0 : _c.filter(
      (r) => r.type !== reaction.type
    );
    const userId = this._channel.getClient().userID;
    messageFromState.latest_reactions = (_d = messageFromState.latest_reactions) == null ? void 0 : _d.filter(
  ...
  _updateQuotedMessageReferences({
    ...
    const parseMessage = (m) => {
      ...
      return {
        ...
        pinned_at: (_a = m.pinned_at) == null ? void 0 : _a.toISOString(),
        updated_at: (_b = m.updated_at) == null ? void 0 : _b.toISOString()
      };
    };
  ...
  filterErrorMessages() {
    ...
    for (const message of blockedMessages) {
      (_a = this._channel.getClient().offlineDb) == null ? void 0 : _a.hardDeleteMessage({ id: message.id });
    }
  ...
  async loadMessageIntoState(messageId, parentMessageId, limit = 25) {
    ...
    loadedMessageThread = !parentMessageId || !!((_a = this.threads[parentMessageId]) == null ? void 0 : _a.find((m) => m.id === messageId));
  ...
  findMessageByTimestamp(timestampMs, parentMessageId, exactTsMatch = false) {
    ...
    const targetMsgSet = (_a = this.messageSets[setIndex]) == null ? void 0 : _a.messages;
    if (!(targetMsgSet == null ? void 0 : targetMsgSet.length)) return null;
...
var CooldownTimer = class extends WithSubscriptions {
  constructor({ channel }) {
    ...
    this.registerSubscriptions = () => {
      ...
      this.addUnsubscribeFunction(
        this.channel.on("message.new", (event) => {
          var _a, _b, _c;
          const isOwnMessage = ((_b = (_a = event.message) == null ? void 0 : _a.user) == null ? void 0 : _b.id) && event.message.user.id === this.getOwnUserId();
          if (!isOwnMessage) return;
          this.setOwnLatestMessageDate(toDateOrUndefined((_c = event.message) == null ? void 0 : _c.created_at));
        }).unsubscribe
      );
      this.addUnsubscribeFunction(
        this.channel.on("channel.updated", (event) => {
          var _a;
          const cooldownChanged = ((_a = event.channel) == null ? void 0 : _a.cooldown) !== this.cooldownConfigSeconds;
    ...
    this.refresh = () => {
      ...
      if (cooldownConfigSeconds !== this.cooldownConfigSeconds || (ownLatestMessageDate == null ? void 0 : ownLatestMessageDate.getTime()) !== ((_a = this.ownLatestMessageDate) == null ? void 0 : _a.getTime()) || canSkipCooldown !== this.canSkipCooldown) {
  ...
  getOwnUserId() {
    ...
    return client.userID ?? ((_a = client.user) == null ? void 0 : _a.id);
  }
  findOwnLatestMessageDate({
    ...
    for (let i = messages.length - 1; i >= 0; i -= 1) {
      const message = messages[i];
      if (((_a = message.user) == null ? void 0 : _a.id) !== ownUserId) continue;
...
var isScrapedContent = (attachment) => !!(attachment == null ? void 0 : attachment.og_scrape_url) || !!(attachment == null ? void 0 : attachment.title_link);
var isLocalAttachment = (attachment) => {
  var _a;
  return !!((_a = attachment == null ? void 0 : attachment.localMetadata) == null ? void 0 : _a.id);
};
var isLocalUploadAttachment = (attachment) => {
  var _a;
  return !!((_a = attachment == null ? void 0 : attachment.localMetadata) == null ? void 0 : _a.uploadState);
};
...
var ensureIsLocalAttachment = (attachment) => {
  ...
  return {
    localMetadata: {
      ...localMetadata ?? {},
      id: (localMetadata == null ? void 0 : localMetadata.id) || generateUUIDv4()
    },
    ...rest
  };
};
...
var createBlockedAttachmentUploadNotificationMiddleware = (composer) => ({
  ...
  handlers: {
    prepare: ({
      ...
      if ((_a = attachment.localMetadata.uploadPermissionCheck) == null ? void 0 : _a.uploadBlocked) {
        composer.client.notifications.addError({
          ...
          options: {
            ...
            metadata: {
              reason: (_b = attachment.localMetadata.uploadPermissionCheck) == null ? void 0 : _b.reason
            }
          }
        });
      }
...
function createMergeCore(options2 = {}) {
  ...
  return function mergeCore({
    ...
    function handleCustomizer(targetValue, srcValue, sourceKey, target2, src, stack) {
      const customValue = customizer == null ? void 0 : customizer(
        targetValue,
        srcValue,
        sourceKey,
        target2,
...
var initState = ({
  ...
  var _a;
  return {
    attachments: (_a = (message == null ? void 0 : message.attachments) ?? []) == null ? void 0 : _a.filter(({ og_scrape_url }) => !og_scrape_url).map((att) => {
...
var _AttachmentManager = class _AttachmentManager2 {
  constructor({ composer, message }) {
    ...
    this.removeAttachments = (localAttachmentIds) => {
      ...
      this.state.partialNext({
        attachments: this.attachments.filter(
          (attachment) => {
            var _a;
            return !localAttachmentIds.includes((_a = attachment.localMetadata) == null ? void 0 : _a.id);
          }
        )
      });
    ...
    this.getUploadConfigCheck = async (fileLike) => {
      ...
      const uploadConfig = isImageFile(fileLike) ? (_a = appSettings == null ? void 0 : appSettings.app) == null ? void 0 : _a.image_upload_config : (_b = appSettings == null ? void 0 : appSettings.app) == null ? void 0 : _b.file_upload_config;
      ...
      if (isFile(fileLike) || isFileReference(fileLike)) {
        if ((allowed_file_extensions == null ? void 0 : allowed_file_extensions.length) && !allowed_file_extensions.some(
          (ext) => fileLike.name.toLowerCase().endsWith(ext.toLowerCase())
        )) {
          return { uploadBlocked: true, reason: "allowed_file_extensions" };
        }
        if ((blocked_file_extensions == null ? void 0 : blocked_file_extensions.length) && blocked_file_extensions.some(
          (ext) => fileLike.name.toLowerCase().endsWith(ext.toLowerCase())
        )) {
          return { uploadBlocked: true, reason: "blocked_file_extensions" };
        }
      }
      if ((allowed_mime_types == null ? void 0 : allowed_mime_types.length) && !allowed_mime_types.some((type) => type.toLowerCase() === (mimeType == null ? void 0 : mimeType.toLowerCase()))) {
        return { uploadBlocked: true, reason: "allowed_mime_types" };
      }
      if ((blocked_mime_types == null ? void 0 : blocked_mime_types.length) && blocked_mime_types.some((type) => type.toLowerCase() === (mimeType == null ? void 0 : mimeType.toLowerCase()))) {
    ...
    this.ensureLocalUploadAttachment = async (attachment) => {
      var _a;
      if (!((_a = attachment.localMetadata) == null ? void 0 : _a.file)) {
    ...
    this.doDefaultUploadRequest = async (fileLike, options2) => {
      const progressHandler = (options2 == null ? void 0 : options2.onProgress) ? (progressEvent) => {
        var _a;
        ...
        (_a = options2.onProgress) == null ? void 0 : _a.call(options2, percent);
      } : void 0;
      const axiosUploadConfig = progressHandler || (options2 == null ? void 0 : options2.abortSignal) ? {
        ...progressHandler ? { onUploadProgress: progressHandler } : {},
        ...(options2 == null ? void 0 : options2.abortSignal) ? { signal: options2.abortSignal } : {}
      } : void 0;
    ...
    this.doUploadRequest = async (fileLike, options2) => {
      const customUploadFn = this.config.doUploadRequest;
      if (customUploadFn) {
        return await customUploadFn(fileLike, options2);
      }
      return this.doDefaultUploadRequest(fileLike, options2);
    };
      ...
      if (localAttachment.localMetadata.uploadState === "blocked") {
        ...
        this.client.notifications.addError({
          ...
          options: {
            type: "validation:attachment:upload:blocked",
            metadata: {
              reason: (_a = localAttachment.localMetadata.uploadPermissionCheck) == null ? void 0 : _a.reason
            }
          }
        });
        return localAttachment;
  ...
  get hasUploadPermission() {
    var _a, _b;
    return !!((_b = (_a = this.channel.data) == null ? void 0 : _a.own_capabilities) == null ? void 0 : _b.includes("upload-file"));
  }
  get isUploadEnabled() {
...
_AttachmentManager.toLocalUploadAttachment = (fileLike) => {
  ...
  localAttachment.localMetadata.previewUri = isFileReference(fileLike) ? fileLike.uri : (_a = URL.createObjectURL) == null ? void 0 : _a.call(URL, fileLike);
...
var CustomDataManager = class {
  constructor({ composer, message }) {
    this.isMessageDataEqual = (nextState, previousState) => JSON.stringify(nextState.message) === JSON.stringify(previousState == null ? void 0 : previousState.message);
    this.initState = ({ message: message2 } = {}) => {
...
var initState3 = ({
  ...
  var _a;
  return message ? {
    previews: ((_a = message.attachments) == null ? void 0 : _a.reduce((acc, attachment) => {
...
var _LinkPreviewsManager = class _LinkPreviewsManager2 {
  constructor({ composer, message }) {
    ...
    this.cancelURLEnrichment = () => {
      var _a, _b, _c, _d;
      (_b = (_a = this.findAndEnrichUrls).cancel) == null ? void 0 : _b.call(_a);
      (_d = (_c = this.findAndEnrichUrls).flush) == null ? void 0 : _d.call(_c);
    };
    this.clearPreviews = () => {
    ...
    this.updatePreview = (url, preview) => {
      ...
      const status = preview.status ?? ((_a = this.previews.get(url)) == null ? void 0 : _a.status) ?? "pending";
    ...
    this.dismissPreview = (url) => {
      ...
      if (preview) {
        (_a = this.onLinkPreviewDismissed) == null ? void 0 : _a.call(this, preview);
  ...
  get enabled() {
    var _a;
    return !!((_a = this.channel.getConfig()) == null ? void 0 : _a.url_enrichment) && this.composer.config.linkPreviews.enabled;
  }
  set enabled(enabled) {
...
var initState4 = ({
  ...
  location: (message == null ? void 0 : message.shared_location) ?? null
});
var LocationComposer = class {
  ...
  get validLocation() {
    ...
    if (!!(location == null ? void 0 : location.created_by_device_id) && location.message_id && location.latitude && location.longitude && (typeof durationMs === "undefined" || durationMs >= MIN_LIVE_LOCATION_SHARE_DURATION)) {
      return {
        ...location,
...
var MessageComposerEffectHandlers = class {
  constructor(options2) {
    ...
    this.applyEffect = (effect) => {
      ...
      handler == null ? void 0 : handler(effect, this.options.composer);
    };
    this.registerDefaultHandlers();
  }
};
...
var pollStateChangeValidators = {
  ...
  max_votes_allowed: ({ data, value }) => {
    ...
    if ((value == null ? void 0 : value.length) > 1 && !value.match(VALID_MAX_VOTES_VALUE_REGEX))
...
var defaultPollFieldBlurEventValidators = {
  ...
  options: (params) => {
    var _a;
    const defaultResult = (_a = pollStateChangeValidators.options) == null ? void 0 : _a.call(pollStateChangeValidators, params);
    const errors = (defaultResult == null ? void 0 : defaultResult.options) ?? {};
...
var isTargetedOptionTextUpdate = (value) => !Array.isArray(value) && typeof (value == null ? void 0 : value.index) === "number" && typeof (value == null ? void 0 : value.text) === "string";
  ...
  return {
    ...
    handlers: {
      handleFieldChange: ({
        ...
        const { newData, newErrors } = universalHandler({
          processors: {
            ...
            ...customProcessors == null ? void 0 : customProcessors.handleFieldChange
          },
          state,
          validators: {
            ...pollStateChangeValidators,
            ...defaultPollFieldChangeEventValidators,
            ...customValidators == null ? void 0 : customValidators.handleFieldChange
          }
        });
        return next({
          ...state,
      ...
      handleFieldBlur: ({
        ...
        const { newData, newErrors } = universalHandler({
          processors: customProcessors == null ? void 0 : customProcessors.handleFieldBlur,
          state,
          validators: {
            ...pollStateChangeValidators,
            ...defaultPollFieldBlurEventValidators,
            ...customValidators == null ? void 0 : customValidators.handleFieldBlur
          }
        });
        return next({
          ...state,
...
var PollComposer = class {
      ...
      const result = await this.compositionMiddlewareExecutor.execute({
        ...
        initialValue: {
          data: {
            ...
            options: (_a = data.options) == null ? void 0 : _a.filter((o) => o.text.trim()).map((o) => ({ text: o.text }))
          },
          errors
        }
      });
  ...
  get initialState() {
    ...
    return {
      data: {
        ...
        user_id: (_a = this.composer.client.user) == null ? void 0 : _a.id,
  ...
  get canCreatePoll() {
    ...
    const maxVotesAllowedNumber = parseInt(
      ((_b = (_a = data.max_votes_allowed) == null ? void 0 : _a.match(VALID_MAX_VOTES_VALUE_REGEX)) == null ? void 0 : _b[0]) || ""
    );
...
var createCompositionDataCleanupMiddleware = (composer) => ({
  ...
  handlers: {
    compose: ({
      ...
      var _a, _b, _c;
      const messageType = !((_a = composer.editedMessage) == null ? void 0 : _a.type) || composer.editedMessage.type === "error" ? "regular" : composer.editedMessage.type;
      const common = {
        type: messageType
      };
      ...
      return next({
        ...
        sendOptions: composer.editedMessage && ((_b = state.sendOptions) == null ? void 0 : _b.skip_enrich_url) ? { skip_enrich_url: (_c = state.sendOptions) == null ? void 0 : _c.skip_enrich_url } : state.sendOptions
      });
    }
  }
});
...
var SearchController = class {
  constructor({ config, sources } = {}) {
    ...
    this.deactivateSource = (sourceType) => {
      const source = this.getSource(sourceType);
      if (!(source == null ? void 0 : source.isActive)) return;
...
var FilterBuilder = class {
  constructor(params) {
    this.context = new StateStore((params == null ? void 0 : params.initialContext) ?? {});
    this.filterConfig = new StateStore(
      (params == null ? void 0 : params.initialFilterConfig) ?? {}
    );
  }
...
var ReminderPaginator = class extends BasePaginator {
  constructor(client, options2) {
    ...
    this.query = async ({
      ...
      var _a;
      const cursor = (_a = this.cursor) == null ? void 0 : _a[direction];
      const {
        reminders: items,
        next,
        prev
...
var UserSearchSource = class extends BaseSearchSource {
  ...
  filterQueryResults(items) {
    return items.filter((u) => {
      var _a;
      return u.id !== ((_a = this.client.user) == null ? void 0 : _a.id);
    });
  }
};
...
var MessageSearchSource = class extends BaseSearchSource {
  constructor(client, options2, filterBuilderOptions) {
    ...
    this.type = "messages";
    this.client = client;
    this.messageSearchChannelFilterBuilder = new FilterBuilder(filterBuilderOptions == null ? void 0 : filterBuilderOptions.messageSearchChannel);
    this.messageSearchFilterBuilder = new FilterBuilder({
      ...filterBuilderOptions == null ? void 0 : filterBuilderOptions.messageSearch,
      initialFilterConfig: {
        text: {
          enabled: true,
          generate: ({ searchQuery }) => searchQuery ? { text: searchQuery } : null
        },
        ...(_a = filterBuilderOptions == null ? void 0 : filterBuilderOptions.messageSearch) == null ? void 0 : _a.initialFilterConfig
      }
    });
    this.channelQueryFilterBuilder = new FilterBuilder({
      ...filterBuilderOptions == null ? void 0 : filterBuilderOptions.channelQuery,
      initialFilterConfig: {
        cid: {
          enabled: true,
          generate: ({ cids }) => cids ? { cid: { $in: cids } } : null
        },
        ...(_b = filterBuilderOptions == null ? void 0 : filterBuilderOptions.channelQuery) == null ? void 0 : _b.initialFilterConfig
      }
    });
  }
  async query(searchQuery) {
...
var getRawCommandName = (text) => {
  var _a;
  return (_a = text == null ? void 0 : text.match(/^\/(\S+)(?:\s.*)?$/)) == null ? void 0 : _a[1];
};
...
var CommandSearchSource = class extends BaseSearchSourceSync {
  ...
  query(searchQuery) {
    ...
    selectedCommands.sort((a, b) => {
      ...
      if ((nameA == null ? void 0 : nameA.indexOf(searchQuery)) === 0) {
        nameA = `0${nameA}`;
      }
      if ((nameB == null ? void 0 : nameB.indexOf(searchQuery)) === 0) {
        nameB = `0${nameB}`;
      }
...
var createCommandsMiddleware = (channel, options2) => {
  ...
  if (options2 == null ? void 0 : options2.searchSource) {
  ...
  return {
    ...
    handlers: {
      onChange: ({ state, next, complete, forward }) => {
        ...
        if (commandName) {
          const command = searchSource == null ? void 0 : searchSource.query(commandName).items[0];
          const composer = options2 == null ? void 0 : options2.composer;
          if (command && !(composer == null ? void 0 : composer.isCommandDisabled(command))) {
            return next({
              ...state,
              command,
              suggestions: void 0
        ...
        if (triggerWasRemoved) {
          const hasStaleSuggestions = ((_a = state.suggestions) == null ? void 0 : _a.trigger) === finalOptions.trigger;
      ...
      onSuggestionItemSelect: ({ state, next, forward }) => {
        ...
        if (!selectedSuggestion || ((_a = state.suggestions) == null ? void 0 : _a.trigger) !== finalOptions.trigger)
          return forward();
        const composer = options2 == null ? void 0 : options2.composer;
...
var getCommandByName = (searchSource, commandName) => {
  ...
  return searchSource.query(normalizedCommandName).items.find((command) => {
    var _a;
    return ((_a = command.name) == null ? void 0 : _a.toLowerCase()) === normalizedCommandName;
  });
};
...
var createDraftCompositionValidationMiddleware = (composer) => ({
  ...
  handlers: {
    compose: async ({
      ...
      var _a;
      const hasData = !textIsEmpty(state.draft.text ?? "") || ((_a = state.draft.attachments) == null ? void 0 : _a.length) || state.draft.poll_id || state.draft.quoted_message_id;
  ...
  handlers: {
    compose: ({
      ...
      return next({
        ...
        draft: {
          ...state.draft,
          mentioned_users: mentioned_users == null ? void 0 : mentioned_users.map((u) => u.id),
          text
        }
      });
    }
...
var createCommandInjectionMiddleware = (composer) => ({
  handlers: {
    compose: ({
      ...
      const injection = `/${command == null ? void 0 : command.name}`;
...
var isCommandResponse = (suggestion) => typeof (suggestion == null ? void 0 : suggestion.name) === "string";
...
var createCommandStringExtractionMiddleware = () => ({
  handlers: {
    ...
    onSuggestionItemSelect: ({ next, forward, state }) => {
      ...
      const triggerWithCommand = `/${command == null ? void 0 : command.name} `;
...
var TextComposerMiddlewareExecutor = class extends MiddlewareExecutor {
  ...
  async execute({
    ...
    (_a = searchSource == null ? void 0 : searchSource.search(query)) == null ? void 0 : _a.catch(console.error);
    return result;
  }
};
...
var TextComposer = class {
  constructor({ composer, message }) {
    ...
    this.setCommand = (command) => {
      ...
      if (command.name === ((_a = this.command) == null ? void 0 : _a.name)) return;
    ...
    this.handleSelect = async (target) => {
      ...
      if ((output == null ? void 0 : output.status) === "discard") return;
      this.commitState(output.state);
    };
    this.composer = composer;
...
var Thread = class extends WithSubscriptions {
  constructor({
    ...
    this.subscribeMarkThreadStale = () => this.client.on("user.watching.stop", (event) => {
      ...
      if (!this.client.userID || this.client.userID !== ((_a = event.user) == null ? void 0 : _a.id) || ((_b = event.channel) == null ? void 0 : _b.cid) !== channel2.cid) {
        return;
      }
    ...
    this.subscribeNewReplies = () => this.client.on("message.new", (event) => {
      var _a, _b, _c;
      if (!this.client.userID || ((_a = event.message) == null ? void 0 : _a.parent_id) !== this.id) {
        return;
      }
      const isOwnMessage = ((_b = event.message.user) == null ? void 0 : _b.id) === this.client.userID;
      ...
      for (const userId of Object.keys(read)) {
        ...
        if (userRead) {
          ...
          if (userId === ((_c = event.user) == null ? void 0 : _c.id)) {
            nextUserRead = {
              ...nextUserRead,
    ...
    this.deleteReplyLocally = ({ message }) => {
      ...
      if (((_a = replies[index]) == null ? void 0 : _a.id) !== message.id) {
        return;
      }
    ...
    this.loadPage = async (count) => {
      ...
      try {
        ...
        const maybeNextCursor = ((_a = replies.at(count > 0 ? -1 : 0)) == null ? void 0 : _a.id) ?? null;
        this.state.next((current) => {
...
var repliesPaginationFromInitialThread = (thread) => {
  ...
  return {
    nextCursor: null,
    prevCursor: latestRepliesContainsAllReplies ? null : ((_a = thread.latest_replies.at(0)) == null ? void 0 : _a.id) ?? null,
    isLoadingNext: false,
    isLoadingPrev: false
  };
};
var ownUnreadCountSelector = (currentUserId) => (state) => {
  var _a;
  return currentUserId && ((_a = state.read[currentUserId]) == null ? void 0 : _a.unreadMessageCount) || 0;
};
var compositionIsDraftResponse = (composition) => !!(composition == null ? void 0 : composition.message);
...
var _MessageComposer = class _MessageComposer2 extends WithSubscriptions {
  ...
  constructor({
    ...
    this.initStateFromChannelResponse = (channelApiResponse) => {
      ...
      if (channelApiResponse.draft) {
        ...
        this.clear();
        (_a2 = this.client.offlineDb) == null ? void 0 : _a2.executeQuerySafely(
          (db) => db.deleteDraft({
    ...
    this.subscribeMessageUpdated = () => {
      ...
      const unsubscribeFunctions = eventTypes.map(
        (eventType) => this.client.on(eventType, (event) => {
          ...
          if (((_a2 = this.quotedMessage) == null ? void 0 : _a2.id) && event.message.id === this.quotedMessage.id) {
    ...
    this.subscribeMessageComposerSetupStateChange = () => {
      ...
      const unsubscribe = this.client._messageComposerSetupState.subscribeWithSelector(
        ...
        ({ setup }) => {
          ...
          tearDown = (setup == null ? void 0 : setup({ composer: this })) ?? null;
        }
      );
      return () => {
        tearDown == null ? void 0 : tearDown();
    ...
    this.subscribeMessageComposerConfigStateChanged = () => {
      ...
      return () => {
        draftUnsubscribeFunction == null ? void 0 : draftUnsubscribeFunction();
        unsubscribe();
      };
    };
    ...
    this.compose = async () => {
      var _a2, _b;
      const created_at = ((_a2 = this.editedMessage) == null ? void 0 : _a2.created_at) ?? /* @__PURE__ */ new Date();
      const text = "";
      const result = await this.compositionMiddlewareExecutor.execute({
        eventName: "compose",
        initialValue: {
          ...
          localMessage: {
            ...
            mentioned_users: [],
            parent_id: this.threadId ?? void 0,
            pinned_at: ((_b = this.editedMessage) == null ? void 0 : _b.pinned_at) || null,
    ...
    this.getDraft = async () => {
      ...
      const draftFromOfflineDB = await ((_a2 = this.client.offlineDb) == null ? void 0 : _a2.getDraft({
        cid: this.channel.cid,
      ...
      try {
        ...
        if (!draft) return;
        (_b = this.client.offlineDb) == null ? void 0 : _b.executeQuerySafely(
          (db) => db.upsertDraft({
            draft
          }),
          { method: "upsertDraft" }
    ...
    this.createPoll = async () => {
      ...
      try {
        ...
        this.state.partialNext({ pollId: poll == null ? void 0 : poll.id });
      } catch (error) {
        this.client.notifications.addError({
    ...
    this.configState = new StateStore(
      mergeWith(
        ...
        {
          location: {
            enabled: (_a = this.channel.getConfig()) == null ? void 0 : _a.shared_locations
          }
        },
  ...
  get lastChangeOriginIsLocal() {
    ...
    const editedMessageWasUpdated = !!((_a = this.editedMessage) == null ? void 0 : _a.updated_at) && new Date(this.editedMessage.updated_at).getTime() < this.lastChange.stateUpdate;
...
var MessageDeliveryReporter = class _MessageDeliveryReporter {
  constructor({ client }) {
    ...
    this.getNextDeliveryReportCandidate = (collection) => {
      var _a;
      const ownUserId = (_a = this.client.user) == null ? void 0 : _a.id;
      if (!ownUserId) return;
      let latestMessages = [];
      let lastDeliveredAt;
      let lastReadAt;
      ...
      if (isChannel(collection)) {
        ...
        lastReadAt = ownReadState == null ? void 0 : ownReadState.last_read;
        lastDeliveredAt = ownReadState == null ? void 0 : ownReadState.last_delivered_at;
        key = collection.cid;
        ...
        lastReadAt = ownReadState == null ? void 0 : ownReadState.lastReadAt;
        lastDeliveredAt = ownReadState == null ? void 0 : ownReadState.lastDeliveredAt;
  ...
  static hasPermissionToReportDeliveryFor(collection) {
    var _a, _b;
    if (isChannel(collection)) return !!((_a = collection.getConfig()) == null ? void 0 : _a.delivery_events);
    if (isThread(collection)) return !!((_b = collection.channel.getConfig()) == null ? void 0 : _b.delivery_events);
  }
  increaseBackOff() {
  ...
  trackDeliveredCandidate(collection) {
    ...
    if (!(candidate == null ? void 0 : candidate.key)) return;
  ...
  syncDeliveredCandidates(collections) {
    var _a, _b, _c;
    if (((_c = (_b = (_a = this.client.user) == null ? void 0 : _a.privacy_settings) == null ? void 0 : _b.delivery_receipts) == null ? void 0 : _c.enabled) === false) return;
...
var Channel = class {
  ...
  async queryMembers(filterConditions, sort = [], options2 = {}) {
    ...
    if (this.id) {
      id = this.id;
    } else if (((_a = this.data) == null ? void 0 : _a.members) && Array.isArray(this.data.members)) {
  ...
  async updateMemberPartial(updates, options2) {
    ...
    if (options2 == null ? void 0 : options2.userId) {
  ...
  async updatePartial(update) {
    ...
    const areCapabilitiesChanged = [...data.channel.own_capabilities || []].sort().join() !== [
      ...Array.isArray((_a = this.data) == null ? void 0 : _a.own_capabilities) ? (_b = this.data) == null ? void 0 : _b.own_capabilities : []
    ].sort().join();
  ...
  _isTypingIndicatorsEnabled() {
    var _a, _b, _c, _d, _e;
    if (!((_a = this.getConfig()) == null ? void 0 : _a.typing_events) || !((_b = this.getClient().wsConnection) == null ? void 0 : _b.isHealthy)) {
      return false;
    }
    return ((_e = (_d = (_c = this.getClient().user) == null ? void 0 : _c.privacy_settings) == null ? void 0 : _d.typing_indicators) == null ? void 0 : _e.enabled) ?? true;
  }
  /**
  ...
  async markAsReadRequest(data = {}) {
    var _a;
    this._checkInitialized();
    if (!((_a = this.getConfig()) == null ? void 0 : _a.read_events) && !this.getClient()._isUsingServerAuth()) {
      return null;
    }
  ...
  _countMessageAsUnread(message) {
    ...
    if (((_a = message.user) == null ? void 0 : _a.id) === this.getClient().userID) return false;
    if (((_b = message.user) == null ? void 0 : _b.id) && this.getClient().userMuteStatus(message.user.id))
      return false;
    if (Array.isArray((_c = this.data) == null ? void 0 : _c.own_capabilities) && !((_d = this.data) == null ? void 0 : _d.own_capabilities.includes("read-events"))) {
      return false;
    }
  ...
  countUnreadMentions() {
    ...
    for (let i = 0; i < this.state.latestMessages.length; i += 1) {
      const message = this.state.latestMessages[i];
      if (this._countMessageAsUnread(message) && (!lastRead || message.created_at > lastRead) && ((_a = message.mentioned_users) == null ? void 0 : _a.some((user) => user.id === userID))) {
        count++;
      }
    }
    return count;
  ...
  async query(options2 = {}, messageSetToAddToIfDoesNotExist = "current") {
    ...
    await this.getClient().wsPromise;
    const createdById = ((_a = options2.created_by) == null ? void 0 : _a.id) ?? options2.created_by_id ?? ((_c = (_b = this._data) == null ? void 0 : _b.created_by) == null ? void 0 : _c.id) ?? ((_d = this._data) == null ? void 0 : _d.created_by_id);
    ...
    if (!this.id) {
      ...
      const tempChannelCid = generateChannelTempCid(
        ...
        state.members.map((member) => {
          var _a2;
          return member.user_id || ((_a2 = member.user) == null ? void 0 : _a2.id) || "";
        })
      );
    ...
    if (typeof ((_e = state.channel.config) == null ? void 0 : _e.shared_locations) !== "undefined") {
    ...
    messageSet.pagination = {
      ...
      ...messageSetPagination({
        ...
        messagePaginationOptions: options2 == null ? void 0 : options2.messages,
        requestedPageSize: ((_f = options2 == null ? void 0 : options2.messages) == null ? void 0 : _f.limit) ?? DEFAULT_QUERY_CHANNEL_MESSAGE_LIST_PAGE_SIZE,
    ...
    const areCapabilitiesChanged = [...state.channel.own_capabilities || []].sort().join() !== [
      ...this.data && Array.isArray((_g = this.data) == null ? void 0 : _g.own_capabilities) ? this.data.own_capabilities : []
    ].sort().join();
    this.data = state.channel;
    this.offlineMode = false;
    ...
    (_h = this.getClient().offlineDb) == null ? void 0 : _h.executeQuerySafely(
      (db) => {
        var _a2;
        return (_a2 = db.upsertChannels) == null ? void 0 : _a2.call(db, {
          channels: [state],
  ...
  _handleChannelEvent(event) {
    ...
    switch (event.type) {
      case "typing.start":
        if ((_a = event.user) == null ? void 0 : _a.id) {
          channelState.typing[event.user.id] = event;
        }
        break;
      case "typing.stop":
        if ((_b = event.user) == null ? void 0 : _b.id) {
          delete channelState.typing[event.user.id];
        }
        break;
      case "message.read":
        if (((_c = event.user) == null ? void 0 : _c.id) && event.created_at) {
          ...
          const client = this.getClient();
          const isOwnEvent = ((_d = event.user) == null ? void 0 : _d.id) === ((_e = client.user) == null ? void 0 : _e.id);
          if (isOwnEvent) {
      ...
      case "message.delivered":
        if (((_f = event.user) == null ? void 0 : _f.id) && event.created_at) {
          const previousReadState = channelState.read[event.user.id];
          channelState.read[event.user.id] = {
            ...previousReadState,
          ...
          const client = this.getClient();
          const isOwnEvent = ((_g = event.user) == null ? void 0 : _g.id) === ((_h = client.user) == null ? void 0 : _h.id);
          if (isOwnEvent) {
            client.syncDeliveredCandidates([this]);
          }
        }
      ...
      case "user.updated":
        if ((_i = event.user) == null ? void 0 : _i.id) {
          channelState.watchers[event.user.id] = event.user;
        }
        break;
      case "user.watching.stop":
        if ((_j = event.user) == null ? void 0 : _j.id) {
      ...
      case "message.new":
        if (event.message) {
          const client = this.getClient();
          const ownMessage = ((_k = event.user) == null ? void 0 : _k.id) === ((_l = client.user) == null ? void 0 : _l.id);
          ...
          if ((_m = event.user) == null ? void 0 : _m.id) {
      ...
      case "channel.truncated":
        if ((_n = event.channel) == null ? void 0 : _n.truncated_at) {
      ...
      case "member.updated": {
        ...
        if (memberCopy == null ? void 0 : memberCopy.user) {
          channelState.members = {
            ...channelState.members,
            [memberCopy.user.id]: memberCopy
          };
          if (((_o = channel.data) == null ? void 0 : _o.member_count) && event.type === "member.added") {
            channel.data.member_count += 1;
          }
        }
        const currentUserId = this.getClient().userID;
        if (typeof currentUserId === "string" && typeof ((_p = memberCopy == null ? void 0 : memberCopy.user) == null ? void 0 : _p.id) === "string" && memberCopy.user.id === currentUserId) {
          channelState.membership = memberCopy;
        }
        break;
      }
      case "member.removed":
        if ((_q = event.user) == null ? void 0 : _q.id) {
          const newMembers = {
            ...channelState.members
          };
          delete newMembers[event.user.id];
          channelState.members = newMembers;
          if ((_r = channel.data) == null ? void 0 : _r.member_count) {
            channel.data.member_count = Math.max(channel.data.member_count - 1, 0);
          }
        }
        break;
      case "notification.mark_unread": {
        const ownMessage = ((_s = event.user) == null ? void 0 : _s.id) === ((_t = this.getClient().user) == null ? void 0 : _t.id);
      ...
      case "channel.updated":
        if (event.channel) {
          const isFrozenChanged = ((_u = event.channel) == null ? void 0 : _u.frozen) !== void 0 && event.channel.frozen !== ((_v = channel.data) == null ? void 0 : _v.frozen);
          if (isFrozenChanged) {
            this.query({ state: false, messages: { limit: 0 }, watchers: { limit: 0 } });
          }
          const newChannelData = {
            ...event.channel,
            hidden: ((_w = event.channel) == null ? void 0 : _w.hidden) ?? ((_x = channel.data) == null ? void 0 : _x.hidden),
            own_capabilities: ((_y = event.channel) == null ? void 0 : _y.own_capabilities) ?? ((_z = channel.data) == null ? void 0 : _z.own_capabilities)
          };
      ...
      case "channel.hidden":
        channel.data = {
          ...channel.data,
          blocked: !!((_A = event.channel) == null ? void 0 : _A.blocked),
          hidden: true
        };
      ...
      case "channel.visible":
        channel.data = {
          ...channel.data,
          blocked: !!((_B = event.channel) == null ? void 0 : _B.blocked),
          hidden: false
        };
        (_C = this.getClient().offlineDb) == null ? void 0 : _C.handleChannelVisibilityEvent({ event });
        break;
      case "user.banned":
        if (!((_D = event.user) == null ? void 0 : _D.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: !!event.shadow,
          banned: !event.shadow,
          user: { ...((_E = channelState.members[event.user.id]) == null ? void 0 : _E.user) || {}, ...event.user }
        };
        break;
      case "user.unbanned":
        if (!((_F = event.user) == null ? void 0 : _F.id)) break;
        channelState.members[event.user.id] = {
          ...channelState.members[event.user.id] || {},
          shadow_banned: false,
          banned: false,
          user: { ...((_G = channelState.members[event.user.id]) == null ? void 0 : _G.user) || {}, ...event.user }
        };
        break;
      default:
    }
  ...
  _initializeState(state, messageSetToAddToIfDoesNotExist = "latest") {
    ...
    if (state.read) {
      for (const read of state.read) {
        ...
        if (read.user.id === (user == null ? void 0 : user.id)) {
  ...
  constructor({ client }) {
    ...
    this.onclose = (wsID, event) => {
      ...
      if (event.code === chatCodes.WS_CLOSED_SUCCESS) {
        ...
        (_a = this.rejectPromise) == null ? void 0 : _a.call(this, error);
    ...
    this._req = async (params, config, retry) => {
      ...
      try {
        const res = await this.client.doAxiosRequest(
          ...
          void 0,
          {
            config: { ...config, cancelToken: (_a = this.cancelToken) == null ? void 0 : _a.token },
            params
          }
        );
        this.consecutiveFailures = 0;
...
var Segment = class {
  ...
  create() {
    ...
    const body = {
      ...
      filter: (_b = this.data) == null ? void 0 : _b.filter,
      description: (_c = this.data) == null ? void 0 : _c.description,
      all_sender_channels: (_d = this.data) == null ? void 0 : _d.all_sender_channels,
      all_users: (_e = this.data) == null ? void 0 : _e.all_users
    };
...
var ThreadManager = class extends WithSubscriptions {
  ...
  constructor({ client }) {
    ...
    this.subscribeNewReplies = () => this.client.on("notification.thread_message_new", (event) => {
      var _a;
      const parentId = (_a = event.message) == null ? void 0 : _a.parent_id;
      if (!parentId) return;
...
var isVoteAnswer = (vote) => !!(vote == null ? void 0 : vote.answer_text);
var Poll = class {
  constructor({ client, poll }) {
    this.getInitialStateFromPollResponse = (poll2) => {
      const { own_votes, id, ...pollResponseForState } = poll2;
      const { ownAnswer, ownVotes } = (own_votes == null ? void 0 : own_votes.reduce(
        (acc, voteOrAnswer) => {
    ...
    this.upsertOfflineDb = () => {
      var _a;
      (_a = this.client.offlineDb) == null ? void 0 : _a.executeQuerySafely(
    ...
    this.handlePollUpdated = (event) => {
      var _a;
      if (((_a = event.poll) == null ? void 0 : _a.id) && event.poll.id !== this.id) return;
    ...
    this.handleVoteChanged = (event) => {
      ...
      if (isOwnVote) {
        if (isVoteAnswer(event.poll_vote)) {
          ...
          if ((ownAnswer == null ? void 0 : ownAnswer.id) === event.poll_vote.id) {
            ownAnswer = void 0;
          }
          maxVotedOptionIds = getMaxVotedOptionIds(event.poll.vote_counts_by_option);
        }
...
var PollManager = class extends WithSubscriptions {
  constructor({ client }) {
    ...
    this.subscribePollUpdated = () => this.client.on("poll.updated", (event) => {
      var _a, _b;
      if ((_a = event.poll) == null ? void 0 : _a.id) {
        (_b = this.fromState(event.poll.id)) == null ? void 0 : _b.handlePollUpdated(event);
      }
    }).unsubscribe;
    this.subscribePollClosed = () => this.client.on("poll.closed", (event) => {
      var _a, _b;
      if ((_a = event.poll) == null ? void 0 : _a.id) {
        (_b = this.fromState(event.poll.id)) == null ? void 0 : _b.handlePollClosed(event);
      }
    }).unsubscribe;
    this.subscribeVoteCasted = () => this.client.on("poll.vote_casted", (event) => {
      var _a, _b;
      if ((_a = event.poll) == null ? void 0 : _a.id) {
        (_b = this.fromState(event.poll.id)) == null ? void 0 : _b.handleVoteCasted(event);
      }
    }).unsubscribe;
    this.subscribeVoteChanged = () => this.client.on("poll.vote_changed", (event) => {
      var _a, _b;
      if ((_a = event.poll) == null ? void 0 : _a.id) {
        (_b = this.fromState(event.poll.id)) == null ? void 0 : _b.handleVoteChanged(event);
      }
    }).unsubscribe;
    this.subscribeVoteRemoved = () => this.client.on("poll.vote_removed", (event) => {
      var _a, _b;
      if ((_a = event.poll) == null ? void 0 : _a.id) {
        (_b = this.fromState(event.poll.id)) == null ? void 0 : _b.handleVoteRemoved(event);
      }
    }).unsubscribe;
  ...
  constructor({
    ...
    this.executeChannelsQuery = async (payload, retryCount = 0) => {
      ...
      try {
        ...
        const newOffset = offset + ((channels == null ? void 0 : channels.length) ?? 0);
        ...
        this.state.partialNext({
          ...
          pagination: {
            ...pagination,
            hasNext: ((channels == null ? void 0 : channels.length) ?? 0) >= (limit ?? 1),
            isLoading: false,
            options: newOptions
          },
          initialized: true,
    ...
    this.queryChannels = async (filters, sort = [], options3 = {}, stateOptions = {}) => {
      ...
      try {
        ...
        if (((_a = this.client.offlineDb) == null ? void 0 : _a.getChannelsForQuery) && ((_b = this.client.user) == null ? void 0 : _b.id)) {
          if (!initialized) {
    ...
    this.loadNext = async () => {
      ...
      try {
        ...
        const newOffset = offset + ((nextChannels == null ? void 0 : nextChannels.length) ?? 0);
        const newOptions = { ...options3, offset: newOffset };
        this.state.partialNext({
          channels: uniqBy([...channels || [], ...nextChannels], "cid"),
          pagination: {
            ...pagination,
            hasNext: ((nextChannels == null ? void 0 : nextChannels.length) ?? 0) >= (limit ?? 1),
            isLoading: false,
            isLoadingNext: false,
            options: newOptions
          }
    ...
    this.notificationAddedToChannelHandler = async (event) => {
      var _a;
      const { id, type, members } = (event == null ? void 0 : event.channel) ?? {};
      if (!type || !((_a = this.options.allowNotLoadedChannelPromotionForEvent) == null ? void 0 : _a["notification.added_to_channel"])) {
        return;
      }
      const channel = await getAndWatchChannel({
        client: this.client,
        id,
        members: members == null ? void 0 : members.reduce((acc, { user, user_id }) => {
    ...
    this.channelDeletedHandler = (event) => {
      ...
      const channelIndex = newChannels.findIndex(
        (channel) => {
          var _a;
          return channel.cid === (event.cid || ((_a = event.channel) == null ? void 0 : _a.cid));
        }
      );
      if (channelIndex < 0) {
        return;
    ...
    this.newMessageHandler = (event) => {
      ...
      if (
        ...
        !targetChannelExistsWithinList && !((_a = this.options.allowNotLoadedChannelPromotionForEvent) == null ? void 0 : _a["message.new"])
      ) {
        return;
      }
      this.setChannels(
    ...
    this.notificationNewMessageHandler = async (event) => {
      var _a;
      const { id, type } = (event == null ? void 0 : event.channel) ?? {};
      if (!id || !type) {
        return;
      }
      const channel = await getAndWatchChannel({
      ...
      if (!channels || considerArchivedChannels && isTargetChannelArchived && !filters.archived || considerArchivedChannels && !isTargetChannelArchived && filters.archived || !((_a = this.options.allowNotLoadedChannelPromotionForEvent) == null ? void 0 : _a["notification.message_new"])) {
        return;
      }
      this.setChannels(
        promoteChannel({
    ...
    this.channelVisibleHandler = async (event) => {
      ...
      const considerArchivedChannels = shouldConsiderArchivedChannels(filters);
      const isTargetChannelArchived = isChannelArchived(channel);
      if (!channels || considerArchivedChannels && isTargetChannelArchived && !filters.archived || considerArchivedChannels && !isTargetChannelArchived && filters.archived || !((_a = this.options.allowNotLoadedChannelPromotionForEvent) == null ? void 0 : _a["channel.visible"])) {
        return;
      }
      this.setChannels(
        promoteChannel({
    ...
    this.memberUpdatedHandler = (event) => {
      ...
      const { pagination, channels } = this.state.getLatestValue();
      const { filters, sort } = pagination;
      if (!((_a = event.member) == null ? void 0 : _a.user) || event.member.user.id !== this.client.userID || !event.channel_type || !event.channel_id) {
        return;
      }
      const channelType = event.channel_type;
      const channelId = event.channel_id;
      ...
      if (
        ...
        considerArchivedChannels && !isTargetChannelArchived && (filters == null ? void 0 : filters.archived) || // When archived filter false, and channel is archived
        considerArchivedChannels && isTargetChannelArchived && !(filters == null ? void 0 : filters.archived)
      ) {
        this.setChannels(newChannels);
        return;
      }
...
var NotificationManager = class {
  ...
  add({ message, origin, options: options2 = {} }) {
    ...
    const now = Date.now();
    const severity = options2.severity;
    const duration = options2.duration ?? (severity ? this.config.durations[severity] : void 0);
    const notification = {
      id,
      message,
      origin,
  ...
  startTimeout(id, durationOverride) {
    ...
    const duration = durationOverride ?? (notification == null ? void 0 : notification.duration);
...
var ReminderTimer = class {
  constructor({
    ...
    this.init = () => {
      ...
      const boundaryTimestamp = ((_a = this.reminder.remindAt) == null ? void 0 : _a.getTime()) + this.stopRefreshBoundaryMs;
    ...
    if (typeof (config == null ? void 0 : config.stopRefreshBoundaryMs) === "number") {
...
var _ReminderManager = class _ReminderManager2 extends WithSubscriptions {
  constructor({ client, config }) {
    ...
    this.subscribeConfigStateUpdated = () => this.configState.subscribeWithSelector(
      ...
      ({ stopTimerRefreshBoundaryMs }, previousValue) => {
        if (typeof stopTimerRefreshBoundaryMs === "number" && stopTimerRefreshBoundaryMs !== (previousValue == null ? void 0 : previousValue.stopTimerRefreshBoundaryMs)) {
    ...
    this.client = client;
    this.configState = new StateStore({
      scheduledOffsetsMs: (config == null ? void 0 : config.scheduledOffsetsMs) ?? DEFAULT_REMINDER_MANAGER_CONFIG.scheduledOffsetsMs,
      stopTimerRefreshBoundaryMs: (config == null ? void 0 : config.stopTimerRefreshBoundaryMs) ?? DEFAULT_REMINDER_MANAGER_CONFIG.stopTimerRefreshBoundaryMs
    });
  ...
  updateConfig(config) {
    if (typeof config.stopTimerRefreshBoundaryMs === "number" && config.stopTimerRefreshBoundaryMs !== this.stopTimerRefreshBoundaryMs) {
      this.reminders.forEach((reminder) => {
        reminder.timer.stopRefreshBoundaryMs = config == null ? void 0 : config.stopTimerRefreshBoundaryMs;
      });
    }
...
var isMessageUpdateReplayable = (message) => {
  var _a;
  return !((_a = message.attachments) == null ? void 0 : _a.some((attachment) => !isAttachmentReplayable(attachment)));
};
...
var StreamChat = class _StreamChat {
  constructor(key, secretOrOptions, options2) {
    ...
    this.closeConnection = async (timeout) => {
      ...
      await Promise.all([
        (_a2 = this.wsConnection) == null ? void 0 : _a2.disconnect(timeout),
        (_b = this.wsFallback) == null ? void 0 : _b.disconnect(timeout)
      ]);
      (_c = this.offlineDb) == null ? void 0 : _c.executeQuerySafely(
        async (db) => {
          if (this.userID) {
    ...
    this.dispatchEvent = (event) => {
      ...
      (_a2 = this.offlineDb) == null ? void 0 : _a2.executeQuerySafely((db) => db.handleEvent({ event }), {
    ...
    this._updateMemberWatcherReferences = (user) => {
      ...
      for (const channelID in refMap) {
        ...
        if (channel == null ? void 0 : channel.state) {
    ...
    this._updateUserMessageReferences = (user) => {
      ...
      for (const channelID in refMap) {
        ...
        state == null ? void 0 : state.updateUserMessages(user);
      }
    };
    this._deleteUserMessageReference = (user, hardDelete = false, deletedAt) => {
      ...
      for (const channelID in refMap) {
        ...
        if (channel) {
          const state = channel.state;
          state == null ? void 0 : state.deleteUserMessages(user, hardDelete, deletedAt);
        }
      }
    };
    ...
    this.notifications = (options2 == null ? void 0 : options2.notifications) ?? new NotificationManager();
  ...
  async updateAppSettings(options2) {
    ...
    if (apn_config == null ? void 0 : apn_config.p12_cert) {
      options2 = {
        ...options2,
        apn_config: {
          ...apn_config,
  ...
  _handleClientEvent(event) {
    ...
    if (event.type === "notification.channel_mutes_updated" && ((_a = event.me) == null ? void 0 : _a.channel_mutes)) {
      this.mutedChannels = event.me.channel_mutes;
    }
    if (event.type === "notification.mutes_updated" && ((_b = event.me) == null ? void 0 : _b.mutes)) {
    ...
    if ((event.type === "channel.deleted" || event.type === "notification.channel_deleted") && event.cid) {
      ...
      (_c = this.activeChannels[event.cid]) == null ? void 0 : _c._disconnect();
  ...
  _muteStatus(cid) {
    ...
    for (let i = 0; i < this.mutedChannels.length; i++) {
      ...
      if (((_a = mute.channel) == null ? void 0 : _a.cid) === cid) {
        muteStatus = {
   ...
   */
  async queryFutureChannelBans(options2 = {}) {
  ...
  async queryChannelsRequest(filterConditions, sort = [], options2 = {}) {
    ...
    const { predefined_filter, filter_values, sort_values, ...restOptions } = options2;
  ...
  async queryChannels(filterConditions, sort = [], options2 = {}, stateOptions = {}) {
    ...
    if ((channels == null ? void 0 : channels.length) && ((_a = this.offlineDb) == null ? void 0 : _a.upsertChannels)) {
  ...
  async queryReactions(messageID, filter, sort = [], options2 = {}) {
    ...
    if (((_a = this.offlineDb) == null ? void 0 : _a.getReactions) && !options2.next) {
      try {
      ...
      if (updatedMessagesSet) {
        updatedMessagesSet.pagination = {
          ...
          ...messageSetPagination({
            ...
            requestedPageSize: (queryChannelsOptions == null ? void 0 : queryChannelsOptions.message_limit) || DEFAULT_QUERY_CHANNELS_MESSAGE_LIST_PAGE_SIZE,
  ...
  setLocalDevice(device) {
    var _a, _b, _c;
    if (((_a = this.wsConnection) == null ? void 0 : _a.isConnecting) && this.wsPromise || (((_b = this.wsConnection) == null ? void 0 : _b.isHealthy) || ((_c = this.wsFallback) == null ? void 0 : _c.isHealthy())) && this._hasConnectionID()) {
  ...
  channel(channelType, channelIDOrCustom, custom = {}) {
    ...
    if (!channelIDOrCustom && typeof custom === "object" && ((_a = custom.members) == null ? void 0 : _a.length)) {
  ...
  async updateMessage(message, partialUserOrUserId, options2) {
      ...
      if (this.offlineDb) {
        return await this.offlineDb.queueTask({
          task: {
            ...
            messageId,
            payload: [message, partialUserOrUserId, options2],
            type: "update-message"
          }
        });
      }
    ...
    return await this._updateMessage(message, partialUserOrUserId, options2);
  }
  async _updateMessage(message, partialUserOrUserId, options2) {
    if (!message.id) {
      throw Error("Please specify the message.id when calling updateMessage");
    }
    ...
    } else if (typeof (partialUserOrUserId == null ? void 0 : partialUserOrUserId.id) === "string") {
   ...
   */
  async ephemeralUpdateMessage(messageId, partialMessageObject, partialUserOrUserId, options2) {
  ...
  async deleteMessage(messageID, optionsOrHardDelete) {
    ...
    } else if (optionsOrHardDelete == null ? void 0 : optionsOrHardDelete.deleteForMe) {
      options2 = { deleteForMe: true };
    } else if (optionsOrHardDelete == null ? void 0 : optionsOrHardDelete.hardDelete) {
  ...
  _enrichAxiosOptions(options2 = {
    ...
    if (!((_a = options2.headers) == null ? void 0 : _a["x-client-request-id"])) {
      options2.headers = {
        ...options2.headers,
  ...
  getCampaign(id, options2) {
    this.validateServerSideAuth();
    return this.get(this.baseURL + `/campaigns/${encodeURIComponent(id)}`, { ...options2 == null ? void 0 : options2.users });
  }
  startCampaign(id, options2) {
    this.validateServerSideAuth();
    return this.post(this.baseURL + `/campaigns/${encodeURIComponent(id)}/start`, {
      scheduled_for: options2 == null ? void 0 : options2.scheduledFor,
      stop_at: options2 == null ? void 0 : options2.stopAt
    });
  }
  /**
   ...
   */
  async queryTeamUsageStats(options2 = {}) {
    return await this.post(
  ...
  async markChannelsDelivered(data) {
    var _a;
    if (!((_a = data == null ? void 0 : data.latest_delivered_messages) == null ? void 0 : _a.length)) return;
   ...
   */
  async createPredefinedFilter(options2) {
    this.validateServerSideAuth();
    return await this.post(
   ...
   */
  async updatePredefinedFilter(name, options2) {
    this.validateServerSideAuth();
    return await this.put(
      `${this.baseURL}/predefined_filters/${encodeURIComponent(name)}`,
      options2
   ...
   */
  async listPredefinedFilters(options2 = {}) {
    this.validateServerSideAuth();
    const { sort, ...paginationOptions } = options2;
    return await this.get(
      `${this.baseURL}/predefined_filters`,
      {
        ...paginationOptions,
   ...
   */
  async getRetentionPolicyRuns(options2 = {}) {
    this.validateServerSideAuth();
    return await this.post(
...
var OfflineDBSyncManager = class {
  constructor({
    ...
    this.init = async () => {
      var _a, _b;
      try {
        if (((_a = this.client.user) == null ? void 0 : _a.id) && ((_b = this.client.wsConnection) == null ? void 0 : _b.isHealthy)) {
    ...
    this.sync = async () => {
      ...
      try {
        ...
        const error = e;
        if (((_c = (_b = error.response) == null ? void 0 : _b.data) == null ? void 0 : _c.code) === 23) {
          return;
        }
        await this.offlineDb.resetDB();
      }
...
var AbstractOfflineDB = class {
  constructor({ client }) {
    ...
    this.queriesWithChannelGuard = async ({
      ...
      const cid = event.cid || (channelFromEvent == null ? void 0 : channelFromEvent.cid);
    ...
    this.handleNewMessage = async ({
      ...
      const finalQueries = await this.queriesWithChannelGuard(
        ...
        async () => {
          ...
          if (cid && client2.user && client2.user.id !== (user == null ? void 0 : user.id)) {
    ...
    this.handleRead = async ({
      ...
      if ((user == null ? void 0 : user.id) && cid) {
        return await this.queriesWithChannelGuard(
          { event, execute },
    ...
    this.queueTask = async ({ task }) => {
      const attemptTaskExecution = async () => {
        var _a;
        if (!((_a = this.client.wsConnection) == null ? void 0 : _a.isHealthy)) {
    ...
    this.shouldSkipQueueingTask = (error) => {
      var _a, _b, _c, _d;
      return ((_b = (_a = error == null ? void 0 : error.response) == null ? void 0 : _a.data) == null ? void 0 : _b.code) === 4 || ((_d = (_c = error == null ? void 0 : error.response) == null ? void 0 : _c.data) == null ? void 0 : _d.code) === 17;
    };
    ...
    this.handleAddPendingTask = async ({ task }) => {
      ...
      if (task.type === "update-message" && !((_a = this.client.wsConnection) == null ? void 0 : _a.isHealthy) && task.payload[0].status === "failed") {
    ...
    this.executeTask = async ({ task }, isPendingTask = false) => {
      ...
      if (channelType && channelId) {
        ...
        if (task.type === "send-message") {
          ...
          const newMessage = newMessageResponse == null ? void 0 : newMessageResponse.message;
          if (isPendingTask && newMessage) {
            if (newMessage == null ? void 0 : newMessage.parent_id) {
              (_a = this.client.threads.threadsById[newMessage.parent_id]) == null ? void 0 : _a.upsertReplyLocally({
                message: newMessage,
...
function isValidLiveLocationMessage(message) {
  var _a;
  if (!message || message.type === "deleted" || !((_a = message.shared_location) == null ? void 0 : _a.end_at))
    return false;
...
var _LiveLocationManager = class _LiveLocationManager2 extends WithSubscriptions {
  ...
  subscribeTargetMessagesChange() {
    ...
    const unsubscribe = this.state.subscribeWithSelector(
      ...
      ({ messages }) => {
        if (!messages.size) {
          unsubscribeWatchLocation == null ? void 0 : unsubscribeWatchLocation();
  ...
  subscribeLiveLocationSharingUpdates() {
    const subscriptions = [
      ...
      this.client.on("live_location_sharing.stopped", (event) => {
        ...
        this.unregisterMessages([(_a = event.live_location) == null ? void 0 : _a.message_id]);
      })
    ];
  ...
  registerMessage(message) {
    var _a;
    if (!this.client.userID || ((_a = message == null ? void 0 : message.user) == null ? void 0 : _a.id) !== this.client.userID || !isValidLiveLocationMessage(message))
      return;
...
var FixedSizeQueueCache = class {
  constructor(size, options2) {
    ...
    this.dispose = (options2 == null ? void 0 : options2.dispose) ?? null;
  }
  /**
  ...
  add(key, value) {
    ...
    if (index > -1) {
      ...
      if (itemKey) {
        ...
        if (item) {
          (_a = this.dispose) == null ? void 0 : _a.call(this, itemKey, item);
        }
...
//# sourceMappingURL=chunk-XQSQ62OM.js.map
