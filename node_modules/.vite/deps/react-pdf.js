...
import * as pdfjs5 from "pdfjs-dist";
...
// node_modules/react-pdf/dist/Document.js
var { PDFDataRangeTransport } = pdfjs;
...
import * as pdfjs2 from "pdfjs-dist";
...
function AnnotationLayer2() {
  ...
  (0, import_react11.useEffect)(function renderAnnotationLayer() {
    ...
    layer.innerHTML = "";
    try {
      new pdfjs2.AnnotationLayer(annotationLayerParameters).render(renderParameters);
      onRenderSuccess();
    } catch (error) {
      onRenderError(error);
    }
...
// node_modules/react-pdf/dist/Page/Canvas.js
var ANNOTATION_MODE = pdfjs3.AnnotationMode;
...
import * as pdfjs4 from "pdfjs-dist";
...
function TextLayer2() {
  ...
  (0, import_react15.useLayoutEffect)(function renderTextLayer() {
    ...
    const cancellable = new pdfjs4.TextLayer(parameters);
    const runningTask = cancellable;
...
pdfjs5.GlobalWorkerOptions.workerSrc = "pdf.worker.mjs";
export {
